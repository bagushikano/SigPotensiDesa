    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Foto Pusat Pemerintahan</h5>
                <button class="btn-close" id="closeModal" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
                <div class="form-group">
                    <label class="d-flex justify-content-center" for="inputFoto">Foto Potensi Desa (Pusat Pemerintahan)</label>
                    @if ($puspem->foto == NULL)
                        <p class="text-center">Foto belum ditambahkan</p>
                        <img class="mb-2" id="img_preview" src="" width="100%" alt="">
                    @else
                        <img class="mb-2" id="img_preview" src="{{ route('Image Puspem', $puspem->id) }}" width="100%" alt="">
                    @endif
