<div class="modal fade" id="tentang" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="tentangLabel" aria-hidden="true">
        ...
        <div class="modal-content">
            ...
            <form action="">
                ...
                <div class="modal-footer my-auto mx-auto">
                    <p class="my-auto mx-auto text-muted small">Sistem Informasi Geografis Potensi Desa - Matakuliah GIS 2021</p>
                </div>
            </form>
        </div>
    </div>
