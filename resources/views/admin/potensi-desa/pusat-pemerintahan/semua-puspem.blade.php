...
@section('content')
    <div class="d-flex justify-content-between flex-wrap flex-md-nowrap pt-3 pb-2 mb-3 border-bottom">
        <h1 class="h3 col-lg-auto text-center text-md-start">Manajemen Pusat Pemerintahan</h1>
                    ...
                    <div class="card-header">
                        <div class="row">
                            ...
                            <div class="col-6 my-auto d-flex justify-content-end">
                                <a href="{{ route('Tambah Puspem') }}" class="card-title btn btn-success my-auto">
                                    ...
                                    @foreach ($puspem as $data)
                                        <tr class="text-center align-middle my-auto">
                                            ...
                                            <td class="text-center align-middle d-md-none">
                                                ...
                                                <button onclick="deletePuspem('{{$data->id}}')" class="btn btn-sm btn-danger">
                                            ...
                                            <form action="{{ route('Hapus Puspem', $data->id) }}" id="hapus-puspem" method="POST" class="d-inline">
                                                @csrf
                                            </form>
                                        </tr>
                                    @endforeach
...
@push('js')
    ...
    <script type="text/javascript">
        ...
        function deletePuspem(desa) {
            Swal.fire({
                title: 'Peringatan',
                text: 'Apakah anda yakin akan menghapus pusat pemerintahan ?',
                icon: 'warning',
