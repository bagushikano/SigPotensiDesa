...
@section('content')
    <div class="d-flex justify-content-between flex-wrap flex-md-nowrap pt-3 pb-2 mb-3 border-bottom">
        <h1 class="h3 col-lg-auto text-center text-md-start">Manajemen Sekolah</h1>
                ...
                <div class="card">
                    ...
                    @if ($sekolah->count() < 1)
                        <div class="card-body my-auto">
                            <p class="fs-5 my-auto text-center">Tidak Terdapat Data Sekolah</p>
                        </div>
                    @else
                                ...
                                <tbody>
                                    @foreach ($sekolah as $data)
                                        <tr class="text-center align-middle my-auto">
                                            ...
                                            <form action="{{ route('Hapus Sekolah', $data->id) }}" id="hapus-sekolah" method="POST" class="d-inline">
                                                @csrf
                                            </form>
                                        </tr>
                                    @endforeach
...
@push('js')
    ...
    <script type="text/javascript">
        ...
        function deleteSekolah(desa) {
            Swal.fire({
                title: 'Peringatan',
                text: 'Apakah anda yakin akan menghapus sekolah ?',
                icon: 'warning',
